...
Route::group(function () {
    ...
    //TODO
    Route::get('product/paycode/:id/[:type]', 'store.StoreProductController/paycode')->name('paycode');//收款码
    Route::get('product/paycodebyorder/:id/[:type]', 'store.StoreProductController/paycodebyorder')->name('paycodebyorder');//收款码
