<?php /*a:5:{s:56:"/mnt/www/wst/app/admin/view/agent/agent_manage/index.php";i:1586535509;s:48:"/mnt/www/wst/app/admin/view/public/container.php";i:1586535509;s:49:"/mnt/www/wst/app/admin/view/public/frame_head.php";i:1586535509;s:44:"/mnt/www/wst/app/admin/view/public/style.php";i:1586535509;s:51:"/mnt/www/wst/app/admin/view/public/frame_footer.php";i:1586535509;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
                ...
                <div class="layui-card-body">
                    ...
                    <script type="text/html" id="act">
                        ...
                        <ul class="layui-nav-child layui-anim layui-anim-upbit">
                            <li>
                                <a href="javascript:void(0);" class="" onclick="$eb.createModalFrame(this.innerText,'<?php echo Url('stair'); ?>?uid={{d.uid}}')">
                                    <i class="fa fa-list-alt"></i> 统计推广人列表
                                </a>
                            </li>
                            <li>
                                <a href="javascript:void(0);" class="" onclick="$eb.createModalFrame(this.innerText,'<?php echo Url('stair_order'); ?>?uid={{d.uid}}')">
