<?php /*a:1:{s:45:"/mnt/www/wst/app/admin/view/widget/images.php";i:1586535510;}*/ ?>
<!DOCTYPE html>
                    ...
                    <div class="layui-card-body clearfix image-box" style="padding: 10px;height: 360px;z-index:10;">
                        ...
                        <div class="empty-image" style="width: 100%;height: 100%;text-align: center;" v-if="!imageList.length && loading == false">
                            <div class="layui-img-box">
                                <img src="/system/images/empty.jpg" style="height: 400px;" alt="" >
                            </div>
                        </div>
                    </div>
...
<script src="/system/js/layuiList.js?id=dsfwef"></script>
<script>
    var pid = <?php echo htmlentities($pid); ?>,small = <?php echo app('request')->param('small')?: 0; ?> ,parentinputname = '<?php echo htmlentities(app('request')->param('fodder')); ?>';//当前图片分类ID
