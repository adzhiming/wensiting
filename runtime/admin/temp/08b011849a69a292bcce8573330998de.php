<?php /*a:1:{s:52:"/mnt/www/wst/app/admin/view/sms/sms_config/index.php";i:1586535509;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <div class="ibox float-e-margins">
                ...
                <?php endif; ?>
                    <div class="ibox-content">
                        <div id="app">
                            <Alert type="success">如果还没有开通短信账号,可以<a href="<?php echo Url('sms.smsAdmin/index'); ?>" style="color: #0000ff">立即注册</a>
                            </Alert>
                        </div>
