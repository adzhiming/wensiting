<?php /*a:3:{s:51:"/mnt/www/wst/app/admin/view/sms/sms_admin/index.php";i:1586535509;s:43:"/mnt/www/wst/app/admin/view/public/head.php";i:1586535509;s:44:"/mnt/www/wst/app/admin/view/public/style.php";i:1586535509;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
    ...
    mpFrame.start(function(Vue){
        new Vue({
            ...
            methods: {
                ...
                submit(){
                    var that = this;
                    $eb.axios.post("<?php echo Url('save'); ?>",that.form).then(function(res){
                        if(res.status == 200 && res.data.code == 200){
                            $eb.message('success',res.data.msg || '提交成功!');
                            $eb.closeModalFrame(window.name);
                            location.href = "<?php echo url('sms.smsConfig/index', array('type'=>4, 'tab_id'=>18)); ?>";
                        }else{
